...
@Component({
  ...
  template: `
    <div class="delete-dialog-wrap">
      ...
      <h2 class="delete-dialog-title" mat-dialog-title>Delete Employee</h2>
      ...
      <mat-dialog-content class="delete-dialog-body">
        <p class="warning-text">
          ...
          associated data and credentials.
        </p>
      </mat-dialog-content>
...
export class EmployeeDeleteConfirmComponent {
  constructor(
    public dialogRef: MatDialogRef<EmployeeDeleteConfirmComponent>
  ) { }
}
